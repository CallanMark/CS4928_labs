...
import com.cafepos.domain.LineItem; // NOTE : In the code on the lab sheet he had this as import com.cafepos.order.LineItem; , maybe we should change the folder name 
